...
window.MagicZoom = (function() {
    ...
    var u, q = {},
        ...
        F, y = true,
        g = z.browser.features.perspective ? "translate3d(" : "translate(",
    ...
    var s = function() {
        return "mgctlbxN$MZ" + "".toUpperCase() + " mgctlbxV$" + "v5.1.13".replace("v", "") + " mgctlbxL$" + "t".toUpperCase() + ((window.mgctlbx$Pltm && "string" == z.jTypeOf(window.mgctlbx$Pltm)) ? " mgctlbxP$" + window.mgctlbx$Pltm.toLowerCase() : "")
    };
    ...
    k.prototype = {
        ...
        setSize: function(J, N) {
            var M = z.detach(this.zoomBox.size),
                L = (!this.expanded && this.zoomBox.custom) ? i(this.zoomBox.custom).jGetSize() : {
                    width: 0,
                    height: 0
                },
                I, H, K = this.size,
        ...
        registerDeactivateEvent: function(I) {
            ...
            var J = this.node.jFetch("mz:handlers:deactivate:fn", i(function(K) {
                if (c(K) && !h(K)) {
                    return
                }
